...
export const GlobalStateContext = createContext<ContextState | undefined>(undefined);

export const GlobalMutatorContext = createContext<Dispatch<Action> | undefined>(undefined);
...
const GlobalProvider = ({  children }:  { children: React.ReactNode }) => {
    ...
    return (
        <GlobalStateContext.Provider value={state}>
            <GlobalMutatorContext.Provider value={dispatch}>{children}</GlobalMutatorContext.Provider>
